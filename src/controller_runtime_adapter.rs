...
pub(crate) struct RootControllerPodPort {
    ...
    api: Option<Arc<crate::pod_api_service::PodApiService>>,
    subresource: Option<Arc<crate::pod_subresource_service::PodSubresourceService>>,
}
...
impl crate::kubelet::pod_repository::PodObjectWriter for RootControllerPodPort {
    async fn create_controller_pod(
        ...
        if self.api.is_none() {
            return crate::kubelet::pod_repository::PodObjectWriter::create_controller_pod(
                self.repository.as_ref(),
                namespace,
                name,
                _node_name,
        ...
        let result = klights_pod_api::PodApiMutation::create_pod(
            self.api
                .as_deref()
                .expect("production root Pod API is wired"),
...
impl crate::kubelet::pod_repository::PodSubresourceWriter for RootControllerPodPort {
    async fn replace_status_from_api(
        ...
        crate::kubelet::pod_repository::PodSubresourceWriter::replace_status_from_api(
            self.repository.as_ref(),
            namespace,
            name,
            status,
    ...
    async fn replace_status_from_api_for_uid(
        ...
        crate::kubelet::pod_repository::PodSubresourceWriter::replace_status_from_api_for_uid(
            self.repository.as_ref(),
            namespace,
            name,
            pod_uid,
    ...
    async fn patch_status_from_api(
        ...
        crate::kubelet::pod_repository::PodSubresourceWriter::patch_status_from_api(
            self.repository.as_ref(),
            namespace,
            name,
            patch,
