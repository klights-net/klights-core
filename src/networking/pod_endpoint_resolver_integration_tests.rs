...
mod tests {
    ...
    async fn build_resolver() -> (Arc<NodeLocalStores>, Datastore, StorePodEndpointResolver) {
        ...
        let resolver = StorePodEndpointResolver::new(node_network.clone(), node_network, topology);
