//! Kubernetes timestamp representation.
//!
//! This module owns wire-format precision only. Callers that make policy
//! decisions from wall time receive a `DateTime<Utc>` from their composition
//! boundary and call the deterministic formatters here.
