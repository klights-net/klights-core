...
async fn denying_operational_router() -> axum::Router {
    ...
    crate::bootstrap::native_api_composition::support::build_test_router_with_authorizer_and_operational_endpoints(authorizer).await
}
...
async fn klights_status_route_exposes_role_and_metadata() {
    let state = crate::bootstrap::native_api_composition::support::build_test_app_state_with_operational_endpoints().await;
