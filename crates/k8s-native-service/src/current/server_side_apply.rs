...
//! strategic-merge path uses ([`crate::current::helpers::strategic_merge_key`]);
...
use crate::current::helpers::strategic_merge_key;
...
pub fn server_side_apply(
    ...
    let mut merged = crate::current::helpers::strategic_merge(base.clone(), applied, "");
