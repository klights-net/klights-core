...
macro_rules! namespaced_resource_handlers {
    ($kind:expr_2021, $list_kind:expr_2021, $api_version:expr_2021, $list_fn:ident, $get_fn:ident, $create_fn:ident, $update_fn:ident, $delete_fn:ident, $patch_fn:ident, $delete_collection_fn:ident) => {
        pub(in crate::current) async fn $list_fn(
            ...
            crate::generic_read::list_inner(
                state,
                &identity,
                crate::generic_read::GeneratedListInnerRequest {
        ...
        pub(in crate::current) async fn $get_fn(
            State(state): State<Arc<ApiState>>,
            Path((namespace, name)): Path<(String, String)>,
            headers: HeaderMap,
            axum::Extension(identity): axum::Extension<klights_auth::AuthenticatedIdentity>,
        ) -> Result<Response, AppError> {
            crate::generic_read::get_inner(
                state,
                &identity,
                $api_version,
                $kind,
        ...
        pub(in crate::current) async fn $create_fn(
            State(state): State<Arc<ApiState>>,
            Path(namespace): Path<String>,
            ...
            crate::generic_command::create_inner(
                state,
                &identity,
                $api_version,
                $kind,
        ...
        pub(in crate::current) async fn $update_fn(
            State(state): State<Arc<ApiState>>,
            Path((namespace, name)): Path<(String, String)>,
            Query(query): Query<CreateUpdateQuery>,
            axum::Extension(identity): axum::Extension<klights_auth::AuthenticatedIdentity>,
            ...
            crate::generic_command::update_inner(
                state,
                &identity,
                crate::generic_command::GeneratedUpdateInnerRequest {
        ...
        pub(in crate::current) async fn $delete_fn(
            State(state): State<Arc<ApiState>>,
            Path((namespace, name)): Path<(String, String)>,
            Query(query): Query<CreateUpdateQuery>,
            axum::Extension(identity): axum::Extension<klights_auth::AuthenticatedIdentity>,
            ...
            crate::generic_command::delete_inner(
                state,
                &identity,
        ...
        pub(in crate::current) async fn $patch_fn(
            State(state): State<Arc<ApiState>>,
            Path((namespace, name)): Path<(String, String)>,
            Query(query): Query<CreateUpdateQuery>,
            headers: HeaderMap,
            ...
            crate::generic_command::patch_inner(
                state,
                &identity,
                crate::generic_command::GeneratedPatchInnerRequest {
                    target: crate::generic_command::GeneratedNamedResource::new(
                        $api_version,
                        $kind,
                        Some(&namespace),
        ...
        pub(in crate::current) async fn $delete_collection_fn(
            State(state): State<Arc<ApiState>>,
            Path(namespace): Path<String>,
            Query(query): Query<DeleteCollectionQuery>,
            axum::Extension(identity): axum::Extension<klights_auth::AuthenticatedIdentity>,
        ) -> Result<Json<Value>, AppError> {
            crate::generic_command::delete_collection_inner(
                state,
                &identity,
                $api_version,
                $kind,
...
// Pod handlers are owned by `crate::current::pod_handlers`. The macro
...
macro_rules! cluster_wide_list_handler {
    ($kind:expr_2021, $list_kind:expr_2021, $api_version:expr_2021, $fn_name:ident) => {
        pub(in crate::current) async fn $fn_name(
            State(state): State<Arc<ApiState>>,
            Query(query): Query<ListQuery>,
            headers: HeaderMap,
            axum::Extension(identity): axum::Extension<klights_auth::AuthenticatedIdentity>,
...
// The cluster-wide Pod list is owned by `crate::current::pod_handlers`.
