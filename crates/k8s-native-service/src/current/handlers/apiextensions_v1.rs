...
pub async fn delete_custom_resources_for_crd(
    ...
    for (api_version, namespace, name) in targets {
        crate::generic_command::delete_non_pod_resource(
...
pub async fn delete_crd_with_deregistration(
    ...
    let _ = crate::generic_command::update_non_pod_resource(
        state.resource_mutation().resource_command.as_ref(),
        "apiextensions.k8s.io/v1",
        "CustomResourceDefinition",
        None,
...
pub async fn delete_collection_customresourcedefinitions(
    ...
    let resources = crate::current::resource_query_ports::list_resources(
        state.resource_mutation().resource_query.as_ref(),
        "apiextensions.k8s.io/v1",
        "CustomResourceDefinition",
    ...
    for resource in &resources {
        ...
        delete_custom_resources_for_crd(&state, &resource.data).await?;
        let _ = crate::generic_command::delete_non_pod_resource(
            state.resource_mutation().resource_command.as_ref(),
            "apiextensions.k8s.io/v1",
            "CustomResourceDefinition",
            None,
...
async fn create_crd_with_registration(
    ...
    if let Err(e) = crate::current::discovery::register_crd_from_value(
    ...
    let updated = crate::current::status_command_ports::update_resource_status(
        state.resource_mutation().resource_command.as_ref(),
        "apiextensions.k8s.io/v1",
        "CustomResourceDefinition",
        None,
...
async fn update_crd_with_registration(
    ...
    let main_resource = crate::generic_command::update_non_pod_resource(
        state.resource_mutation().resource_command.as_ref(),
        "apiextensions.k8s.io/v1",
        "CustomResourceDefinition",
        None,
    ...
    .await?;
    let resource = crate::current::status_command_ports::update_resource_status(
        state.resource_mutation().resource_command.as_ref(),
        "apiextensions.k8s.io/v1",
        "CustomResourceDefinition",
        None,
...
async fn patch_crd_with_registration(
    ...
    if content_type == Some("application/apply-patch+yaml") {
        let exists = crate::current::resource_query_ports::get_resource(
            state.resource_mutation().resource_query.as_ref(),
            "apiextensions.k8s.io/v1",
            "CustomResourceDefinition",
            None,
        ...
        if !exists {
            ...
            let response_resource =
                match crate::current::status_command_ports::update_resource_status(
                    state.resource_mutation().resource_command.as_ref(),
                    "apiextensions.k8s.io/v1",
                    "CustomResourceDefinition",
                    None,
    ...
    for attempt in 0..max_retries {
        ...
        match crate::generic_command::update_non_pod_resource(
            state.resource_mutation().resource_command.as_ref(),
            "apiextensions.k8s.io/v1",
            "CustomResourceDefinition",
            None,
