...
use crate::current::apiservice_proxy::resolve_service_proxy_target;
use crate::current::watch_event::{EventType, WatchEvent};
...
pub async fn load_crd_conversion_config(
    ...
    let Some(crd) = crate::current::resource_query_ports::get_resource(
        query,
...
pub async fn convert_crd_objects_to_requested_version(
    ...
    let response_bytes = crate::current::pod_subresources::read_reqwest_body_limited(
        resp,
        crate::current::pod_subresources::MAX_APISERVICE_RESPONSE_BODY_BYTES,
