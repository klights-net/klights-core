...
use crate::redb::RedbOrdinaryNamespaceStore;
...
impl RedbNamespaceStore {
    ...
    ) -> Result<klights_cluster_store::ResourceList> {
    ...
    pub async fn update_ns_with_preconditions_impl(
        &self,
        name: &str,
        data: Value,
        ...
        self.ordinary
            .update_namespace_with_preconditions(name, data, preconditions)
            .await
    }
    ...
    pub async fn delete_ns_observed_rv_impl(&self, name: &str) -> Result<i64> {
        self.ordinary.delete_namespace_observed_rv(name).await
    }

    pub async fn delete_ns_with_preconditions_impl(
        &self,
        name: &str,
        preconditions: klights_cluster_core::ResourcePreconditions,
    ) -> Result<i64> {
        self.ordinary
            .delete_namespace_with_preconditions(name, preconditions)
            .await
    }
