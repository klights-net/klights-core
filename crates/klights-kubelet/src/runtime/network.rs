        ...
        self.repository
            ...
            .map_err(|error| match error {
                PodNetworkAssignmentError::TimedOut(_) => anyhow::Error::new(
                    crate::pod_startup_error::PodStartupErrorKind::NetworkAssignmentTimedOut,
                )
...
mod focused_datapath_tests {
    ...
    fn test_kubelet_caller_takes_only_datapath() {
        type Constructor = fn(
            ...
            Arc<dyn crate::pod_repository::PodNetworkAssignmentQuery>,
...
pub(crate) mod test_support {
    ...
    #[async_trait::async_trait]
    impl crate::runtime::network::PodNetworkRuntime for MockPodNetworkRuntime {
        async fn read_assignment(
            &self,
            sandbox_id: &str,
            key: &crate::runtime_types::PodRuntimeKey,
            host_network: bool,
        ) -> anyhow::Result<crate::pod_repository::PodNetworkAssignment> {
            ...
            Ok(crate::pod_repository::PodNetworkAssignment {
