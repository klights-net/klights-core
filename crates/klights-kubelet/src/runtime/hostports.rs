...
mod tests {
    ...
    async fn hostport_admission_allows_same_name_recreate_with_different_uid() {
        let repository =
            Arc::new(crate::runtime::test_repository::InMemoryPodRepository::default());
        ...
        let pod_query = repository as Arc<dyn klights_pod_api::PodQuery>;
        let recreated = json!({
...
pub(crate) mod test_support {
    ...
    #[async_trait::async_trait]
    impl crate::runtime::hostports::HostPortRuntime for MockHostPortRuntime {
