...
pub async fn ensure_termination_log_host_file(
    ...
    crate::pod_fs::PodFs::ensure_termination_log(file_process, std::path::PathBuf::from(&path))
        .await
}
...
mod tests {
    ...
    fn test_termination_log_host_path_returns_expected_path() {
        let runtime_paths = crate::runtime_paths::KubeletRuntimePaths::for_test("klights");
